...
function checkCollisions(){
    ...
    for(const j of junk) {
        for(const s of ships){
		    ...
		    if(
			    //collision in x axis firsy
			    //right side of ship is to the right of lef side junk
			    ship_max_x > junk_min_x
			    //left side of ship is tp the left of right side junk
			    && ship_min_x < junk_max_x

			    //y axis
			    //top of ship is above bottom of junk
			    && ship_min_y < junk_max_y
			    //bottom of ship is below top of junk
